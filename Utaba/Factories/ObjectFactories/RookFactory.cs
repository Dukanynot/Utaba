...
namespace Utaba.Factories.ObjectFactories
{
    ...
    {
        private static readonly Lazy<RookFactory> LazyRookFactory = new Lazy<RookFactory>(() => new RookFactory());
        private RookFactory() { }

        public static RookFactory Singleton = LazyRookFactory.Value;
